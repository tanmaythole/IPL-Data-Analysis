...
def predict(home_team, away_team, city, toss_winner, toss_decision):
    matches_cleaned_data = pd.read_csv('C:\\Users\\Tanmay Thole\\Desktop\\IPL Data Analysis\\IPL Data Analysis\\Dataset\\matches_cleaned.csv')
...
def calculate_ef_score(home, away):
    data = pd.read_csv('C:\\Users\\Tejas Bhavsar\\Desktop\\IPL Data Analysis\\Dataset\\_team_rank.csv')
