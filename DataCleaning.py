...
def write_csv(x: list) -> object:
    ...
    clean_file = open("C:\\Users\\Tejas Bhavsar\\Desktop\\IPL Data Analysis\\Dataset\\matches_cleaned.csv", 'w', newline='')
    with clean_file:
...
if "__main__" == __name__:
    matches_list = read_csv('C:\\Users\\Tejas Bhavsar\\Desktop\\IPL Data Analysis\\Dataset\\matches.csv')
    ...
    # print(team_dict)
    with open('C:\\Users\\Tejas Bhavsar\\Desktop\\IPL Data Analysis\\jsonDumps\\team_dict.json', 'w') as outfile:
    ...
    with open('C:\\Users\\Tejas Bhavsar\\Desktop\\IPL Data Analysis\\jsonDumps\\toss_decision_dict.json', 'w') as outfile:
    ...
    # print(city_dict)
    with open('C:\\Users\\Tejas Bhavsar\\Desktop\\IPL Data Analysis\\jsonDumps\\city_dict.json', 'w') as outfile:
